...
//        }
        ...
        try {
            ...
            JSONObject object = new JSONObject(params);
            {
                ...
                switch (object.getString("From")) {
                    case "farmer": {

                        title = object.getString("title");
                        message = object.getString("message");
                        from = object.getString("From");
                        img = object.getString("profile");

                        Intent intent = new Intent(this, DoctorHomeActivity.class);
                        intent.putExtra("notify", "complaint");
                        Notify.build(this)
                                .setTitle("New Message Recieved From " + from)
                                .setContent("Message:" + title)
                                .setSmallIcon(R.drawable.cattle_icon)
                                .setLargeIcon(img)
                                .largeCircularIcon()
                               // .setPicture()
                                .setColor(R.color.theme_light_color)
                                .setAction(intent)
                                .show();
                        break;
                    }
